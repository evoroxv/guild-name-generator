...
$(document).ready(function(){
    ...
    $("#the_button").click(function(){
        ...
        var occupation1 = ['Herbalist', 'Falconer', 'Illustrator', 'Gravekeeper', 'Gambler', 'Fletcher', 'Painter', 'Poet', 'World-Sailor', 'Storyteller', 'Locksmith', 'Wizard', 'Prophet', 'Armourer', 'Astrologer', 'Barber-Surgeon', 'Blacksmith', 'Brewer', 'Cartwright', 'Clerk', 'Cobbler', 'Engineer', 'Needlemaker', 'Jailer', 'Mason', 'Clock-maker', 'Gunsmith', 'Witch', 'Thatcher', 'Stonecutter', 'Servant', 'Tax Collector', 'Gong Farmer','Weaponsmith', 'Woodcarver', 'Apothecary', 'Woolwinder', 'Architect', 'Banker', 'Bookbinder', 'Tailor', 'Swineherd', 'Thatcher', 'Chirurgeon', 'Alchemist', 'Bureaucrat', 'Sculptor', 'Rat Catcher', 'Rag Man', 'Miner', 'Leatherworker', 'Jeweller', 'Drunkard', 'Cooper', 'Fisherman', 'Goatherd', 'Goliard', 'Hunter', 'Cheese-maker', 'Cook', 'Baker', 'Brasier', 'Embroiderer', 'Carpenter', 'Basket-weaver', 'Warrior', 'Mercenary', 'Thief', 'Scoundrel', 'Necromancer', 'Ranger', 'Woodsman', 'Apprentice', 'Preacher', 'Evangelist', 'Cultist', 'Glassblower', 'Gardener', 'Minstrel', 'Miller', 'Porter', 'Poultry-keeper', 'Scullion', 'Shepherd', 'Explorer', 'Monk', 'Priest', 'Duellist'];
