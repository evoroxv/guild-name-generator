...
label { border: 2px solid slateblue; color: crimson }
...
<label>Non-standard Generation <input type="checkbox" id="generator2"> </label>
...
$(document).ready(function(){
    ...
    $("#the_button").click(function(){
        ...
        var occupation1 = ['Herbalists', 'Falconers', 'Illustrators', 'Gravediggers', 'Gamblers', 'Fletchers', 'Painters', 'Poets', 'World-Sailors', 'Storytellers', 'Locksmiths', 'Wizards', 'Piss-Prophets', 'Armourers', 'Astrologers', 'Barber-Surgeons', 'Blacksmiths', 'Brewers', 'Cartwrights', 'Clerks', 'Cobblers']
		...
		var hq_type = ['Bastille', 'Fortress', 'Fort', 'Keep', 'Castle', 'Vault', 'Spire', 'Tower', 'Bank']
		var hq_style = ['Secret', 'Hidden', 'Mystical', 'Flying', 'Floating', 'Mundane', 'Grandiose', 'Giant', 'Wealthy']
		var hq_feature = ['a network of tunnels', 'a heavily-gaurded room', 'an aqueduct', 'a throne room', 'a moat', 'a stable', 'lots of paintings', 'an endless hallway']
		...
		var extra = " This guild's HQ is a {0} {1}. It includes {2}.".formatUnicorn(hq_style[r5], hq_type[r4], hq_feature[r6]);
